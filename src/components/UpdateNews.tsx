                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          We have added proxy server, dubbed animes, Anime
                          livestreaming and more. We are giving all this so that
                          you do not face any problem while using AnimeFlix and
                          you can happily watch your favorite anime.
                          <br />
                          <br />
